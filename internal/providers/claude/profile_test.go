...
func TestProfileGet_FullSchema(t *testing.T) {
	body := []byte(`{
		"account": {
			"uuid": "acct-uuid-1",
...
func TestProfileGet_EmptyUUID(t *testing.T) {
	body := []byte(`{
		"account": {
			"uuid": "",
			"email": "user@example.com",
...
func TestProfileGet_EmptyEmail(t *testing.T) {
	body := []byte(`{
		"account": {
			"uuid": "acct-uuid-1",
			"email": "",
...
func TestProfileGet_PersonalAccount_NoOrganization(t *testing.T) {
	body := []byte(`{
		"account": {
...
func TestProfileGet_401_WrapsErrAuthDenied(t *testing.T) {
...
func TestProfileGet_503_WrapsErrTransient(t *testing.T) {
...
func TestProfileGet_NonJSON200_BareError(t *testing.T) {
